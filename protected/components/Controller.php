    ...
    public static function createAdminMenu()
    {
        if(Yii::app()->user->roles === 'admin' || Yii::app()->user->roles === 'superAdmin')
            return array(
                ...
                array(
                    'label' => '<i class="fa fa-bars"></i><span>غذاها</span> <i class="fa fa-angle-left pull-left"></i>',
                    'url' => '#',
                    'itemOptions' => array('class' => 'treeview', 'tabindex' => "-1"),
                    'submenuOptions' => array('class' => 'treeview-menu'),
                    'items' => array(
                        array('label' => '<i class="fa fa-circle-o"></i>مدیریت غذاها', 'url' => Yii::app()->createUrl('/products/manage/admin')),
                        array('label' => '<i class="fa fa-circle-o"></i>آپلود فایل منو', 'url' => Yii::app()->createUrl('/setting/manage/menu')),
                    )
                ),
                array(
                    'label' => '<i class="fa fa-picture-o"></i><span>مدیریت اسلایدر</span>',
                    'url' => array('/slideshow/manage/admin')
                ),
                array(
